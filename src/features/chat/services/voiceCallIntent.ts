...
const EXPLICIT_CALLBACK_REQUEST_PATTERN = /(?:给我(?:打|拨)(?:个|一下)?(?:电话|语音(?:电话|通话)?|视频(?:电话|通话)?)|(?:你|对方).{0,8}(?:给我(?:打|拨)(?:个|一下)?|打过来|拨过来|打回来|拨回来|回拨)|(?:让|请|叫)(?:你|对方).{0,8}(?:给我)?(?:打|拨)(?:个|一下)?(?:电话|语音(?:电话|通话)?|视频(?:电话|通话)?)|(?:重新|再|待会儿?|一会儿?).{0,8}(?:给我打|给我拨|打过来|拨过来|回拨|打回来|拨回来))/u;
