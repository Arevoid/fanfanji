    ...
    observations.forEach((observation, index) => {
      ...
      const record = recordDirectChatMemoryLongEvidence({
        ...
        candidate: {
          ...
          ...(observation ? {
            legacyProvenanceTrusted: observation.legacyProvenanceTrusted,
            v2ProvenanceTrusted: observation.v2ProvenanceTrusted,
            legacyScopeExact: observation.legacyScopeExact,
            v2ScopeExact: observation.v2ScopeExact,
            legacySourceRefsPresent: observation.legacySourceRefsPresent,
            v2SourceRefsPresent: observation.v2SourceRefsPresent,
            legacySourceRefsAllowed: observation.legacySourceRefsAllowed,
            v2SourceRefsAllowed: observation.v2SourceRefsAllowed,
            legacyLineageStatus: observation.legacyLineageStatus,
            v2LineageStatus: observation.v2LineageStatus,
            legacyMatchCount: observation.legacyMatchCount,
            v2MatchCount: observation.v2MatchCount,
            eligiblePairCount: observation.eligiblePairCount,
            ...(observation.correlationReason ? { correlationReason: observation.correlationReason } : {}),
          } : {}),
