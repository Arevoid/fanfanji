...
const tests: Array<[string, () => void]> = [
  ...
  ["D collector preserves the user as the gift provider without replaying the transcript", () => assert.ok(collectOfflineHandoffContent(currentStory).includes("用户向当前角色赠送过糖果。"))],
  ...
  ["P the final mock API request contains the sugar fact", () => assert.ok(finalMockApiRequest.systemInstruction.includes("用户向当前角色赠送过糖果。"))],
