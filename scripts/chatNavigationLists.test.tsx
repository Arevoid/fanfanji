...
const checks: Array<[string, boolean]> = [
  ...
  ["K conversation root class remains", list.includes("divide-y divide-[var(--divider)]")],
  ["L item class remains", list.includes("flex items-center p-3 cursor-pointer transition-colors relative")],
  ["M contact item class remains", contacts.includes("flex items-center p-3 hover:bg-[var(--surface-muted)] cursor-pointer transition-colors")],
