...
assert.match(server, /Content-Security-Policy[\s\S]*CONTENT_SECURITY_POLICY|CONTENT_SECURITY_POLICY[\s\S]*Content-Security-Policy/);
assert.match(worker, /Content-Security-Policy[\s\S]*CONTENT_SECURITY_POLICY|CONTENT_SECURITY_POLICY[\s\S]*Content-Security-Policy/);
