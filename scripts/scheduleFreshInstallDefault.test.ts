...
assert.match(app, /id: "character-phone", type: "app"[\s\S]*row: 4, column: 2/);
assert.match(app, /id: "forum", type: "app"[\s\S]*row: 4, column: 3/);
assert.match(app, /id: "reading", type: "app"[\s\S]*row: 5, column: 0/);
assert.match(app, /id: "cinema", type: "app"[\s\S]*row: 5, column: 1/);
assert.match(app, /id: "relationship-network", type: "app"[\s\S]*row: 5, column: 2/);
assert.match(app, /id: "diary", type: "app"[\s\S]*row: 5, column: 3/);
