...
const assets = fs.readFileSync(path.join(root, "src/features/settings/hooks/useSettingsAssetActions.ts"), "utf8");
...
assert.match(assets, /const input = event\.currentTarget/);
assert.match(assets, /input\.value = ""/);
