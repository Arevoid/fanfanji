...
assert.equal(isExplicitIncomingCallRequest("给我打个电话"), true);
assert.equal(isExplicitIncomingCallRequest("给我打个视频电话"), true);
assert.equal(isExplicitIncomingCallRequest("让对方给我打视频电话"), true);
...
assert.equal(isExplicitIncomingVideoCallRequest("给我打个视频电话"), true);
assert.equal(isExplicitIncomingVideoCallRequest("让对方给我打视频电话"), true);
